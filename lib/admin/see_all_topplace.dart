...
class AllTopPlace extends StatefulWidget {
  const AllTopPlace({super.key});

  @override
  State<AllTopPlace> createState() => _AllTopPlaceState();
}

class _AllTopPlaceState extends State<AllTopPlace> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        elevation: 0,
        title: Text("See All Top Tours",style: TextStyle(fontSize: 25.sp),),
      ),
      body: StreamBuilder(
        stream:
            FirebaseFirestore.instance.collection('top-places').snapshots(),
